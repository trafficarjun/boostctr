...
ActiveRecord::Schema.define(version: 2019_12_30_062132) do
  ...
  create_table "tests", force: :cascade do |t|
    ...
    t.boolean "four_week_before_updated", default: false
    t.boolean "one_week_after_updated", default: false
    t.boolean "two_week_after_updated", default: false
    t.boolean "four_week_after_updated", default: false
  end
