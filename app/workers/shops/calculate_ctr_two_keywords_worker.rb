class Shops::CalculateCtrTwoKeywordsWorker
  ...
  def perform(shop_id)
    ...
    if shop
      keywords = shop.keywords.where(keyword_count: 2, includes_brand_name: false)
      ...
      old_ctr_at_1 = shop.clicks.where(ctr_type: "2keywords", rank: 1)
      old_ctr_at_2 = shop.clicks.where(ctr_type: "2keywords", rank: 2)
      old_ctr_at_3 = shop.clicks.where(ctr_type: "2keywords", rank: 3)
      old_ctr_at_4 = shop.clicks.where(ctr_type: "2keywords", rank: 4)
      old_ctr_at_5 = shop.clicks.where(ctr_type: "2keywords", rank: 5)
      old_ctr_at_6 = shop.clicks.where(ctr_type: "2keywords", rank: 6)
      old_ctr_at_7 = shop.clicks.where(ctr_type: "2keywords", rank: 7)
      old_ctr_at_8 = shop.clicks.where(ctr_type: "2keywords", rank: 8)
      old_ctr_at_9 = shop.clicks.where(ctr_type: "2keywords", rank: 9)
      old_ctr_at_10 = shop.clicks.where(ctr_type: "2keywords", rank: 10)
      
      #update the average ctr for the shop
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 1, ctr: position_1_average_ctr_for_keywords) if !old_ctr_at_1.any?
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 2, ctr: position_2_average_ctr_for_keywords) if !old_ctr_at_2.any?
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 3, ctr: position_3_average_ctr_for_keywords) if !old_ctr_at_3.any?
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 4, ctr: position_4_average_ctr_for_keywords) if !old_ctr_at_4.any?
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 5, ctr: position_5_average_ctr_for_keywords) if !old_ctr_at_5.any?
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 6, ctr: position_6_average_ctr_for_keywords) if !old_ctr_at_6.any?
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 7, ctr: position_7_average_ctr_for_keywords) if !old_ctr_at_7.any?
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 8, ctr: position_8_average_ctr_for_keywords) if !old_ctr_at_8.any?
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 9, ctr: position_9_average_ctr_for_keywords) if !old_ctr_at_9.any?
      Click.create(shop_id: shop.id, ctr_type: "2keywords", rank: 10, ctr: position_10_average_ctr_for_keywords) if !old_ctr_at_10.any?
    end
  end
end
