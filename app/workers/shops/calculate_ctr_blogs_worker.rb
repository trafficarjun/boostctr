class Shops::CalculateCtrBlogsWorker
  ...
  def perform(shop_id)
    ...
    if shop
      pages = shop.pages.where(shopify_page_type: "blogs")
      ...
      old_ctr_at_1 = shop.clicks.where(ctr_type: "blogs", rank: 1)
      old_ctr_at_2 = shop.clicks.where(ctr_type: "blogs", rank: 2)
      old_ctr_at_3 = shop.clicks.where(ctr_type: "blogs", rank: 3)
      old_ctr_at_4 = shop.clicks.where(ctr_type: "blogs", rank: 4)
      old_ctr_at_5 = shop.clicks.where(ctr_type: "blogs", rank: 5)
      old_ctr_at_6 = shop.clicks.where(ctr_type: "blogs", rank: 6)
      old_ctr_at_7 = shop.clicks.where(ctr_type: "blogs", rank: 7)
      old_ctr_at_8 = shop.clicks.where(ctr_type: "blogs", rank: 8)
      old_ctr_at_9 = shop.clicks.where(ctr_type: "blogs", rank: 9)
      old_ctr_at_10 = shop.clicks.where(ctr_type: "blogs", rank: 10)
      
      #update the average ctr for the shop
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 1, ctr: position_1_average_ctr_for_group_of_pages) if !old_ctr_at_1.any?
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 2, ctr: position_2_average_ctr_for_group_of_pages) if !old_ctr_at_2.any?
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 3, ctr: position_3_average_ctr_for_group_of_pages) if !old_ctr_at_3.any?
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 4, ctr: position_4_average_ctr_for_group_of_pages) if !old_ctr_at_4.any?
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 5, ctr: position_5_average_ctr_for_group_of_pages) if !old_ctr_at_5.any?
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 6, ctr: position_6_average_ctr_for_group_of_pages) if !old_ctr_at_6.any?
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 7, ctr: position_7_average_ctr_for_group_of_pages) if !old_ctr_at_7.any?
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 8, ctr: position_8_average_ctr_for_group_of_pages) if !old_ctr_at_8.any?
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 9, ctr: position_9_average_ctr_for_group_of_pages) if !old_ctr_at_9.any?
      Click.create(shop_id: shop.id, ctr_type: "blogs", rank: 10, ctr: position_10_average_ctr_for_group_of_pages) if !old_ctr_at_10.any?
    end
  end
end
